...
func main() {
	...
	callGetSeatMapPerSubClass(kaiClient)
}

func callGetSeatMapPerSubClass(kaiClient *kaiwsdkv2.KAIHttpClient) {
	...
	// fmt.Println(vRS.Return.TrainNo)
	// fmt.Println(vRS.Return.SeatMaps[0].WagonCode)
	// fmt.Println(vRS.Return.SeatMaps[0].Seats[0].SubClass)
