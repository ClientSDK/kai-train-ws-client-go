...
func main() {
	...
	callGetSeatNull(kaiClient)
}

func callGetSeatNull(kaiClient *kaiwsdkv2.KAIHttpClient) {
	...
	// fmt.Println(vRS.Return.SeatNulls[0].WagonCode)
	// fmt.Println(vRS.Return.SeatNulls[0].Seats[0].SubClass)
