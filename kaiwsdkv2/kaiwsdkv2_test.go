...
func TestCallManualSeatFalse(t *testing.T) {
	...
	params["book_code"] = "ABMNYZ"
	params["wagon_code"] = "EKS"
	params["wagon_no"] = "1"
	params["seat"] = "5A,5B,5C,5D"

	vRS, err = kaiClient.CallManualSeat(params, false)
...
func TestCallPaymentFalse(t *testing.T) {
	...
	params["book_code"] = "ABMNYZ"
	params["pay_type"] = "TUNAI"

	vRS, err = kaiClient.CallPayment(params, false)
...
func TestCallCancelPaymentFalse(t *testing.T) {
	...
	vRS, err = kaiClient.CallCancelPayment(params, false)
